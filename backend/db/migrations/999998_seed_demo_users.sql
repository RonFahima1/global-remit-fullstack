...
VALUES (gen_random_uuid(), 'orgadmin', 'orgadmin@example.com', true, '$2a$10$WdzGhO1DRtp3DK7hpbSpV.oIWM/nxeaeaPRE2upZ3d.0tJdLo29ve', 'ACTIVE', 'Org', 'Admin', NOW(), NOW(), 1)
ON CONFLICT (email) DO NOTHING;

-- AGENT_ADMIN
INSERT INTO auth.users (id, username, email, email_verified, password_hash, status, first_name, last_name, created_at, updated_at, version)
VALUES (gen_random_uuid(), 'agentadmin', 'agentadmin@example.com', true, '$2a$10$WdzGhO1DRtp3DK7hpbSpV.oIWM/nxeaeaPRE2upZ3d.0tJdLo29ve', 'ACTIVE', 'Agent', 'Admin', NOW(), NOW(), 1)
ON CONFLICT (email) DO NOTHING;

-- AGENT_USER
INSERT INTO auth.users (id, username, email, email_verified, password_hash, status, first_name, last_name, created_at, updated_at, version)
VALUES (gen_random_uuid(), 'agentuser', 'agentuser@example.com', true, '$2a$10$WdzGhO1DRtp3DK7hpbSpV.oIWM/nxeaeaPRE2upZ3d.0tJdLo29ve', 'ACTIVE', 'Agent', 'User', NOW(), NOW(), 1)
ON CONFLICT (email) DO NOTHING;

-- COMPLIANCE_USER
INSERT INTO auth.users (id, username, email, email_verified, password_hash, status, first_name, last_name, created_at, updated_at, version)
VALUES (gen_random_uuid(), 'complianceuser', 'complianceuser@example.com', true, '$2a$10$WdzGhO1DRtp3DK7hpbSpV.oIWM/nxeaeaPRE2upZ3d.0tJdLo29ve', 'ACTIVE', 'Compliance', 'User', NOW(), NOW(), 1)
ON CONFLICT (email) DO NOTHING;

-- ORG_USER
INSERT INTO auth.users (id, username, email, email_verified, password_hash, status, first_name, last_name, created_at, updated_at, version)
VALUES (gen_random_uuid(), 'orguser', 'orguser@example.com', true, '$2a$10$WdzGhO1DRtp3DK7hpbSpV.oIWM/nxeaeaPRE2upZ3d.0tJdLo29ve', 'ACTIVE', 'Org', 'User', NOW(), NOW(), 1)
ON CONFLICT (email) DO NOTHING;
